...
\begin{itemize}
	...
	\end{lstlisting}
	Questo è l'unico metodo che non possiede chiamate effettive al back end, infatti quando l'utente vuole effettuare il log out verrà semplicemente chiamato un metodo che fa ritornare l'utente alla homepage e cancella i dati dell'utente nello stato persistente. Infine viene svuotato il localStorage dai dati dell'utente;
	\item \textbf{modifca dati personali}
	\begin{lstlisting}
