...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.9\columnwidth]{immagini/login.png}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.9\columnwidth]{immagini/registrazione.png}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.9\columnwidth]{immagini/uploadOpera.png}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.8\columnwidth]{immagini/modificaDati.png}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.8\columnwidth]{immagini/modificaPassword.png}
